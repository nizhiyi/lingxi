...
<p align="center">
  <strong>本地优先 · 多模型 · 多智能体 · Agent 间对话 · 开箱即用</strong>
</p>
...
> **不只是聊天工具。** 创建你的专属智能体团队，赋予它们技能和知识库，编排自动化工作流，甚至让不同电脑上的 Agent 跨网络对话 —— 一切都在本地运行。
...
macOS 下载 `.dmg` 双击安装。内嵌 Go 后端 + Node.js + whisper.cpp —— 无需 Python、Docker 或后端服务。
...
Light · Dark · Midnight · Cyber · Aurora · Cosmos。CSS 变量驱动零闪烁切换，Framer Motion 丝滑页面过渡。
...
> 每个智能体是一个拥有 **8 个维度定制能力** 的完整实体，不只是换一个 System Prompt。
...
<p align="center">
  <img src="images/Agent与Agent对话.png" alt="Agent 间对话" width="900" />
</p>
...
<tr>
<td align="center"><sub>8 维度精细定制</sub></td>
...
| ⚙️ 后端 | Go 1.24 + Gin + SQLite | 70+ API · WebSocket · mDNS · 调度器 |
